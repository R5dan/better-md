...
print("TABLE",
        ...
        inner=[
                ...
                inner=[
                    Tr(
                        inner=[
                            ...
                            Th(inner=[Text("Header 2")], styles={"text-align":"center"}),
                            Th(inner=[Text("Header 3")], styles={"text-align":"right"}),
                            Th(inner=[Text("Header 4")])
                        ],
                    ),
                ]
            ),
            TBody(
                inner=[
                    Tr(
                        inner=[
                            Td(inner=[Text("Row 1 Cell 1")]),
                            Td(inner=[Text("Row 1 Cell 2")]),
                            Td(inner=[Text("Row 1 Cell 3")]),
                            Td(inner=[Text("Row 1 Cell 4")]),
                        ],
                    ),
                    Tr(
                        inner=[
                            ...
                            Td(inner=[Text("Row 2 Cell 3")]),
                            Td(inner=[Text("Row 2 Cell 4")]),
                        ]
                    )
                ]
            )
    ...
    sep="\n" # Only used to keep `TABLE` on  a seperate line than the table
)
